...
public:
    ...
    virtual TToolInfo getToolInfo(const ::Ice::Current& current) = 0;
    /// \cond INTERNAL
    bool _iceD_getToolInfo(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
public:
    ...
    TToolInfo getToolInfo(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makePromiseOutgoing<::RoboCompKinovaArm::TToolInfo>(true, this, &KinovaArmPrx::_iceI_getToolInfo, context).get();
    }

    template<template<typename> class P = ::std::promise>
    auto getToolInfoAsync(const ::Ice::Context& context = ::Ice::noExplicitContext)
        -> decltype(::std::declval<P<::RoboCompKinovaArm::TToolInfo>>().get_future())
    {
        return _makePromiseOutgoing<::RoboCompKinovaArm::TToolInfo, P>(false, this, &KinovaArmPrx::_iceI_getToolInfo, context);
    }

    ::std::function<void()>
    getToolInfoAsync(::std::function<void(::RoboCompKinovaArm::TToolInfo)> response,
                     ::std::function<void(::std::exception_ptr)> ex = nullptr,
                     ::std::function<void(bool)> sent = nullptr,
                     const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<::RoboCompKinovaArm::TToolInfo>(std::move(response), std::move(ex), std::move(sent), this, &RoboCompKinovaArm::KinovaArmPrx::_iceI_getToolInfo, context);
    }

    /// \cond INTERNAL
    void _iceI_getToolInfo(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompKinovaArm::TToolInfo>>&, const ::Ice::Context&);
    /// \endcond
...
template<>
struct StreamableTraits<::RoboCompKinovaArm::TAxis>
{
    static const StreamHelperCategory helper = StreamHelperCategoryStruct;
...
template<typename S>
struct StreamReader<::RoboCompKinovaArm::TAxis, S>
{
    static void read(S* istr, ::RoboCompKinovaArm::TAxis& v)
    {
...
template<>
struct StreamableTraits<::RoboCompKinovaArm::TToolInfo>
{
    static const StreamHelperCategory helper = StreamHelperCategoryStruct;
...
template<typename S>
struct StreamReader<::RoboCompKinovaArm::TToolInfo, S>
{
...
/**
 * Base class for asynchronous callback wrapper classes used for calls to
 * IceProxy::RoboCompKinovaArm::KinovaArm::begin_getToolInfo.
 * Create a wrapper instance by calling ::RoboCompKinovaArm::newCallback_KinovaArm_getToolInfo.
 */
class Callback_KinovaArm_getToolInfo_Base : public virtual ::IceInternal::CallbackBase { };
typedef ::IceUtil::Handle< Callback_KinovaArm_getToolInfo_Base> Callback_KinovaArm_getToolInfoPtr;
...
public:
    ...
    ::RoboCompKinovaArm::TToolInfo getToolInfo(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return end_getToolInfo(_iceI_begin_getToolInfo(context, ::IceInternal::dummyCallback, 0, true));
    }

    ::Ice::AsyncResultPtr begin_getToolInfo(const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _iceI_begin_getToolInfo(context, ::IceInternal::dummyCallback, 0);
    }

    ::Ice::AsyncResultPtr begin_getToolInfo(const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getToolInfo(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getToolInfo(const ::Ice::Context& context, const ::Ice::CallbackPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getToolInfo(context, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getToolInfo(const ::RoboCompKinovaArm::Callback_KinovaArm_getToolInfoPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getToolInfo(::Ice::noExplicitContext, cb, cookie);
    }

    ::Ice::AsyncResultPtr begin_getToolInfo(const ::Ice::Context& context, const ::RoboCompKinovaArm::Callback_KinovaArm_getToolInfoPtr& cb, const ::Ice::LocalObjectPtr& cookie = 0)
    {
        return _iceI_begin_getToolInfo(context, cb, cookie);
    }

    ::RoboCompKinovaArm::TToolInfo end_getToolInfo(const ::Ice::AsyncResultPtr& result);

private:

    ::Ice::AsyncResultPtr _iceI_begin_getToolInfo(const ::Ice::Context&, const ::IceInternal::CallbackBasePtr&, const ::Ice::LocalObjectPtr& cookie = 0, bool sync = false);
...
public:
    ...
    virtual TToolInfo getToolInfo(const ::Ice::Current& current = ::Ice::emptyCurrent) = 0;
    /// \cond INTERNAL
    bool _iceD_getToolInfo(::IceInternal::Incoming&, const ::Ice::Current&);
    /// \endcond
...
template<typename S>
struct StreamWriter< ::RoboCompKinovaArm::TAxis, S>
{
    static void write(S* ostr, const ::RoboCompKinovaArm::TAxis& v)
    {
        ostr->write(v.x);
        ostr->write(v.y);
        ostr->write(v.z);
...
template<typename S>
struct StreamWriter< ::RoboCompKinovaArm::TToolInfo, S>
{
    static void write(S* ostr, const ::RoboCompKinovaArm::TToolInfo& v)
    {
        ostr->write(v.pose);
 ...
 */
template<class T>
class CallbackNC_KinovaArm_getToolInfo : public Callback_KinovaArm_getToolInfo_Base, public ::IceInternal::TwowayCallbackNC<T>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception&);
    typedef void (T::*Sent)(bool);
    typedef void (T::*Response)(const TToolInfo&);

    CallbackNC_KinovaArm_getToolInfo(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallbackNC<T>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
    ...
    virtual void completed(const ::Ice::AsyncResultPtr& result) const
    {
        ...
        try
        {
            ret = proxy->end_getToolInfo(result);
        }
        catch(const ::Ice::Exception& ex)
        {
            ::IceInternal::CallbackNC<T>::exception(result, ex);
 ...
 * @param excb The exception method of the callback object.
 * @param sentcb The sent method of the callback object.
 * @return An object that can be passed to an asynchronous invocation of IceProxy::RoboCompKinovaArm::KinovaArm::begin_getToolInfo.
 */
template<class T> Callback_KinovaArm_getToolInfoPtr
newCallback_KinovaArm_getToolInfo(const IceUtil::Handle<T>& instance, void (T::*cb)(const TToolInfo&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_KinovaArm_getToolInfo<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T> Callback_KinovaArm_getToolInfoPtr
newCallback_KinovaArm_getToolInfo(T* instance, void (T::*cb)(const TToolInfo&), void (T::*excb)(const ::Ice::Exception&), void (T::*sentcb)(bool) = 0)
{
    return new CallbackNC_KinovaArm_getToolInfo<T>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT>
class Callback_KinovaArm_getToolInfo : public Callback_KinovaArm_getToolInfo_Base, public ::IceInternal::TwowayCallback<T, CT>
{
public:
    ...
    typedef void (T::*Exception)(const ::Ice::Exception& , const CT&);
    typedef void (T::*Sent)(bool , const CT&);
    typedef void (T::*Response)(const TToolInfo&, const CT&);

    Callback_KinovaArm_getToolInfo(const TPtr& obj, Response cb, Exception excb, Sent sentcb)
        : ::IceInternal::TwowayCallback<T, CT>(obj, cb != 0, excb, sentcb), _response(cb)
    {
    }
 ...
 * @return An object that can be passed to an asynchronous invocation of IceProxy::RoboCompKinovaArm::KinovaArm::begin_getToolInfo.
 */
template<class T, typename CT> Callback_KinovaArm_getToolInfoPtr
newCallback_KinovaArm_getToolInfo(const IceUtil::Handle<T>& instance, void (T::*cb)(const TToolInfo&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_KinovaArm_getToolInfo<T, CT>(instance, cb, excb, sentcb);
}
 ...
 */
template<class T, typename CT> Callback_KinovaArm_getToolInfoPtr
newCallback_KinovaArm_getToolInfo(T* instance, void (T::*cb)(const TToolInfo&, const CT&), void (T::*excb)(const ::Ice::Exception&, const CT&), void (T::*sentcb)(bool, const CT&) = 0)
{
    return new Callback_KinovaArm_getToolInfo<T, CT>(instance, cb, excb, sentcb);
}
