...
const ::std::string iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name = "getToolInfo";
...
/// \cond INTERNAL
bool
RoboCompKinovaArm::KinovaArm::_iceD_getToolInfo(::IceInternal::Incoming& inS, const ::Ice::Current& current)
{
    _iceCheckMode(::Ice::OperationMode::Normal, current.mode);
    inS.readEmptyParams();
    TToolInfo ret = this->getToolInfo(current);
    auto ostr = inS.startWriteParams();
    ostr->writeAll(ret);
    inS.endWriteParams();
    return true;
...
RoboCompKinovaArm::KinovaArm::_iceDispatch(::IceInternal::Incoming& in, const ::Ice::Current& current)
{
    ...
    switch(r.first - iceC_RoboCompKinovaArm_KinovaArm_ops)
    {
        ...
        case 4:
        {
            return _iceD_getToolInfo(in, current);
        }
        case 5:
        {
...
/// \cond INTERNAL
void
RoboCompKinovaArm::KinovaArmPrx::_iceI_getToolInfo(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::RoboCompKinovaArm::TToolInfo>>& outAsync, const ::Ice::Context& context)
{
    _checkTwowayOnly(iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name);
    outAsync->invoke(iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name, ::Ice::OperationMode::Normal, ::Ice::FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
...
::Ice::AsyncResultPtr
IceProxy::RoboCompKinovaArm::KinovaArm::_iceI_begin_getToolInfo(const ::Ice::Context& context, const ::IceInternal::CallbackBasePtr& del, const ::Ice::LocalObjectPtr& cookie, bool sync)
{
    _checkTwowayOnly(iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name, sync);
    ::IceInternal::OutgoingAsyncPtr result = new ::IceInternal::CallbackOutgoing(this, iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name, del, cookie, sync);
    try
    {
        result->prepare(iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name, ::Ice::Normal, context);
        result->writeEmptyParams();
        result->invoke(iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name);
    }
    catch(const ::Ice::Exception& ex)
    {
        result->abort(ex);
...
IceProxy::RoboCompKinovaArm::KinovaArm::end_getToolInfo(const ::Ice::AsyncResultPtr& result)
{
    ::Ice::AsyncResult::_check(result, this, iceC_RoboCompKinovaArm_KinovaArm_getToolInfo_name);
